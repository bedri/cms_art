...
class MY_Controller extends CI_Controller {
	...
	public function __construct()
	{
		...
		else if(strstr($http_user_agent,"Trident"))
		{
			$browser = "MSIE";
			$browser_version = str_replace("rv:","",substr(strstr($http_user_agent,"rv:"),0,6));
		}
		...
		//print_r($browser);
		if(isset($mobile)) $this->data['mobile'] = json_decode('{"isMobile":1, "type":"$mobile"}');
		else $this->data['mobile'] = json_decode('{"isMobile":0}');
