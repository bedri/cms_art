<div class="adminContentTitle">Add New Content</div>
...
$(document).ready(function() {
	...
	$("#saveButton").click(function() {
		...
		$.post('/admin/conadd',{"name":name, "description":description, "coverImage":coverImage, "action": "save"},function(returned){
			if(returned.success) {
	...
	$("#cancelButton").click(function() {
		...
		$.post('/admin/conadd',{"image":image, "action":"cancel"},function(returned){
			if(returned.success) {
				window.location='<?echo $baseUrl; ?>admin/conlist';
			}
			else {
