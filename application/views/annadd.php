<div class="adminContentTitle">Add New Announcement</div>
...
$(document).ready(function() {
	...
	$("#saveButton").click(function() {
		...
		$.post('/admin/annadd',{"name":name, "description":description, "coverImage":coverImage, "action": "save"},function(returned){
			if(returned.success) {
	...
	$("#cancelButton").click(function() {
		...
		$.post('/admin/annadd',{"image":image, "action":"cancel"},function(returned){
			if(returned.success) {
				window.location='<?echo $baseUrl; ?>admin/annlist';
			}
			else {
